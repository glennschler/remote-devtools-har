...
class RemoteDebugChrome extends DevToolsHelper {
  ...
  */
  ...
  /**
   * @public
   * @method get networkDevTools - get the member object
  */
  get networkDevTools () {
    return this._networkDevTools
  }

  /**
   * @public
   * @method get options - get the options
  */
  get options () {
  ...
  /**
   * @public
   * @method connect - connect to a chrome process
  */
  connect (options) {
    const self = this
    ...
    */
    return ChromeRemoter(options.remoterOptions)
